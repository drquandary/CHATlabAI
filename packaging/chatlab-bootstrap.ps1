...
# ---------------------------------------------------------------------------
function Get-BundleUrl { if ($env:CHATLAB_BUNDLE_URL) { return $env:CHATLAB_BUNDLE_URL }; return 'https://drive.google.com/file/d/1FRMHbF8mEmjyMIVYS-Aa_27TPpBbb-8C/view?usp=share_link' }  # win-64 Google Drive bundle
